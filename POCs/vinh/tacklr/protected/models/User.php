...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('imageURL', 'file','types'=>'jpg, gif, png', 'allowEmpty'=>true, 'on'=>'insert, update'),
			...
			array('userID, groupID, username, password, firstName, lastName, imageURL, gender, DOB, email, telephone, active, updateDate, joinDate', 'safe', 'on'=>'search'),
		);
	}
