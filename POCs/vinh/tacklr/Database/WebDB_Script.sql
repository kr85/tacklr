...
INSERT INTO `tbl_user` VALUES (1,1,'admin',MD5('adminsalt'),'Vinh','Nguyen','user/vinh.jpg','M',NOW(),'nelsonnguyent@gmail.com','(408)930-7362',1,NOW(),NOW()),
						   (2,2,'demo','demo','Demo','User','user/demo.jpg','M',NOW(),'demo@gmail.com','(408)660-7862',1,NOW(),NOW()),
							(3,2,'test','test','Test','User','user/test.jpg','M',NOW(),'test@gmail.com','(408)660-7862',1,NOW(),NOW());
