...
>>>>>>> Created a new sql file 'updade_1.sql' to delete all the tacks that are within a board when the board is deleted. 2. Create, Retrieve (Display), Update, Detele for Category as expected. 3. Create, Retrieve (Display), Update, Delete for Board as expected. 4. Create, Retrieve (Display), Update, Delete for Tack as expected.
